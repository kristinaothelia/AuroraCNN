...
train(json_file, model_name[3], ep=150, batch_size_train=24, learningRate=0.01, stepSize=75, g=0.1)
train(json_file, model_name[4], ep=200, batch_size_train=16, learningRate=0.01, stepSize=75, g=0.1)
