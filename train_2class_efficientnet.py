...
train(json_file, model_name[3], ep=100, batch_size_train=24, learningRate=0.01, stepSize=75, g=0.1)
train(json_file, model_name[4], ep=100, batch_size_train=8, learningRate=0.01, stepSize=75, g=0.1)
